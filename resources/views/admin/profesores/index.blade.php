    ...
    <div class="bg-white rounded-b-xl shadow-sm p-6 mb-4">
        ...
        <details id="detalle-padron" class="text-sm">
            ...
            <form id="form-profesor" method="POST" action="{{ route('admin.profesores.store') }}" class="grid sm:grid-cols-3 gap-3 mt-3">
                ...
                <input type="text" data-solo="letras" maxlength="100" name="apellido" id="input-profesor-apellido" placeholder="Apellido" required class="rounded-lg border border-slate-300 px-3 py-2 text-sm">
                <input type="text" data-solo="letras" maxlength="100" name="nombre" id="input-profesor-nombre" placeholder="Nombre" required class="rounded-lg border border-slate-300 px-3 py-2 text-sm">
                <input type="email" maxlength="100" name="email" id="input-profesor-email" placeholder="Email (opcional)" class="rounded-lg border border-slate-300 px-3 py-2 text-sm">
